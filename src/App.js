...
function App() {
  return (
      ...
      <div class="contents">
        <div class="left-side">
          <div class="left-side-contents">
            ...
            <div class="custome-left-side-text"> 
              <h3>Media enquiries:</h3>
              <span class="custome-text-left" >press@modularbank.com</span>
            </div>

              <div class="custome-left-side-text"> 
              <h3>Career questions:</h3>
              <span class="custome-text-left">careers@modularbank.co</span>
            </div>
          </div>
        </div>
    ...
    <div className="right-side">
        <h2>Contact Us</h2>
          <div class="form-control" >
            <div class="form-group">
              <Lebel text="FirstName"></Lebel>    
              <Input></Input>
            </div>
            <div class="form-group">
              <Lebel text="LastName"></Lebel>
              <Input></Input>
            </div>
        </div>
          <div class="form-control" >
          <div class="form-group">
                <Lebel text="Email"></Lebel>    
                <Input></Input>
              </div>
              <div class="form-group">
                <Lebel text="Job"></Lebel>
                <Input></Input>
              </div>
          </div>
          <br></br><br></br>
        <div class="form-control" >
            <div class="form-group">
              <Lebel text="Company*"></Lebel>    
              <Input></Input>
            </div>
            <div class="form-group">
              <Lebel text="Industry*"></Lebel>
              <Select items={industries}></Select>
            </div>
      </div>

        <div class="form-control" >
            <div class="form-group">
              <Lebel text="Country*"></Lebel>    
              <Select items={countries}></Select>
            </div>
            <div class="form-group">
              <Lebel text="Operating geography*"></Lebel>
              <Select class="custom-select" items={regions}></Select>
            </div>
      </div>
        <div class="form-control" >
      <TextArea></TextArea>
...
class Lebel extends React.Component {
  render(){
    return(
...
class Select extends React.Component {
  render() {
    return(
      <select>
          {this.props.items.map((x)=> <option>{x.name}</option> )}
      </select>
    );
  }
}
...
const industries = [
  {id: 1, name: 'Banking'},
  {id: 2, name: 'Finance'},
  {id: 3, name: 'Telecommunication Industry - ICT industry - IT industry- Digital Industry '},
